...
var a=c.val();if(""!==a&&"http://"!==a){var g=a.split(" "),k=f.val(),D=i.val(),r=m.val(),h=j.val(),o=p.val(),q=w.val(),n=s.val();if(1<g.length){var u='<img style="width:100%" src="xhe_tmpurl"',t=[];""!==k&&(u+=' alt="'+k+'"');""!==D&&(u+=' align="'+D+'"');""!==r&&(u+=' width="'+r+'"');""!==h&&(u+=' height="'+h+'"');""!==o&&(u+=' border="'+o+'"');""!==q&&(u+=' vspace="'+q+'"');""!==n&&(u+=' hspace="'+n+'"');var u=u+" />",v;for(v in g)a=g[v],""!==a&&(a=a.split("||"),k=u,k=k.replace("xhe_tmpurl",a[0]),a[1]&&(k='<a href="'+
